...
<template>
    <footer class="relative text-white pt-16 pb-8 px-6 md:px-8 z-50 bg-neutral-950">
        <div class="max-w-7xl mx-auto z-40">
    ...
    <section class="relative z-40 overflow-hidden bg-neutral-950 py-16 px-8">
        <div class="container">
